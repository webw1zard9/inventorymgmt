    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card-box">
                ...
                <h4 class="text-dark  header-title m-t-0 m-b-30">Order Discount</h4>
...
{{--                            <th>Order SubTotal</th>--}}
                        ...
                        @unless($all_order_discounts_approval->count())
                            <tr>
                        ...
                        @foreach($all_order_discounts_approval as $order_discount_approval)
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($order_discount_approval->no_lines_require_discount_approval)
                                        <span class="text-danger">{{ display_currency($order_discount_approval->items_require_discount_approval) }} ({{ $order_discount_approval->no_lines_require_discount_approval }} items)</span>
                                    @endif
                                </td>
{{--                                <td>{{ display_currency($order_discount_approval->subtotal) }}</td>--}}
                                ...
                                <td><a href="{{ route('sale-orders.show', $order_discount_approval->id) }}" class="btn btn-secondary">Review</a></td>
                                <td>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-danger waves-effect waves-light" type="submit" onclick="return confirm('This will remove all discounts from this order.')">Reject</button>
                                    {{ Form::close() }}
                                </td>
                            </tr>
