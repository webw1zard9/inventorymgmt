...
/* harmony import */ var jquery_typeahead__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jquery-typeahead */ "./node_modules/jquery-typeahead/dist/jquery.typeahead.min.js");
...
$.typeahead({
  ...
  template: function template(query, item) {
    var temp_str = '<span class="row">' + '<span class="username" style="padding-left: 10px">{{name}} ';
    temp_str += '</span></span>';
